...
%% %concentration list
odor_concentration_list = [{'10^-8'}; {'10^-7'}; {'10^-6'}; {'10^-5'}; {'10^-4'}; {'10^-3'}; {'1mM'};{'500uM'};{'10^-7;10^-6'};{'10^-6;10^-6'};{'10^-5;10^-6'};{'10^-6;10^-5'};{'10^-5;10^-5'};{'10^-5;5x10^-6'};{'10^-5;10^-7'};{'10^-5;3x10^-7'};{'10^-5;3x10^-6'};{' '}];    %concentrations
