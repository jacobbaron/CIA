...
%     end
% else
    [odor_seq,flowData] = import_h5_logfile(fname_log);
%     load(fname_log);
...
odor_seq = correct_spelling_dumbass(odor_seq);
odor_seq.odor_inf = odor_inf;
odor_seq.odor_inds = get_odor_inds(odor_seq);
odor_seq.odorSeqStep = odor_seq_step(odor_seq,image_times);
[odor_start_time, odor_end_time] = ...
    calculate_odor_start_end_time(acq_start_time,image_times,odor_seq.odorSeqStep);
